...
public class Question_3_Make_HashMap_Country {
    ...
    public static void main(String[] args) {
        ...
        String[] countryCodesList = {"AF", "AX", "AL", "DZ", "AS", "AD", "AO", "AI", "AQ", "AG", "AR", "AM", "AW", "AU", "AT", "AZ", "BS", "BH", "BD", "BB", "BY", "BE", "BZ", "BJ", "BM", "BT", "BO", "BA", "BW",
        ...
        String[] countryNamesList = {"Afghanistan", "Aland Islands", "Albania", "Algeria", "American Samoa", "Andorra", "Angola", "Anguilla", "Antarctica", "Antigua and Barbuda", "Argentina", "Armenia", "Aruba", "Australia",
        ...
        Map<String, String> countriesAndCodes = createCountryCodesMap(countryCodesList, countryNamesList);
        ...
        while (true) {
            ...
            stringArray2[0] = countriesAndCodes.get(0);
            stringArray2[1] = countriesAndCodes.get(1);
            String countryName = searchCountry(code,stringArray2, stringArray2);
    ...
    public static Map<String, String> createCountryCodesMap(String[] countryCodes, String[] countryNames) {
        Map<String, String> mapCodesCountries = new HashMap<>();
        for (int i = 0; i < countryCodes.length; i++) {
            mapCodesCountries.put(countryCodes[i], countryNames[i]);
        }
        return mapCodesCountries;
    }
